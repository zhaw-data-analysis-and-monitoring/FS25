...
In [the last exercise](#sec-rauman1b), we performed a spatial join between trees and meadows to find out whether a tree is in a meadow or not using data from the Grüental campus (*gruental.gpkg*)
