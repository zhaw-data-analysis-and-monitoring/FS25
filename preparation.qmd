...
```
Folder Week 1 (C:\\Users\\yourname\\semester2\\Modul_DAM\\week_1)
 ¦--slides.pdf                                                  
 ¦--my_notes.docx                                               
...
- the RStudio Project is located in a subfolder of `C:/Users/yourname/semester1/Modul_DAM/week_1` and named `dam-week1-rexercise`.
...
1. Click on "Browse" and switch to *your equivalent* of the folder `C:/Users/yourname/semester1/Modul_DAM/week_1` (the project we are about to initiate will be be created in a subdirectory of this folder). Click on "open" to confirm the selection
